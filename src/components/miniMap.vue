<template>
  <div class="relative w-full h-full min-h-[200px] bg-[var(--bg-secondary)] rounded-xl overflow-hidden border border-thistle shadow-inner">
    <div v-if="!lat || !lng" class="absolute inset-0 flex flex-col items-center justify-center text-paynes-gray/50 p-4 text-center">
      <i class="fa-solid fa-map-location-dot text-3xl mb-2"></i>
      <p class="text-xs font-bold uppercase tracking-widest">posizione non impostata</p>
    </div>
