<template>
  <div class="space-y-8 animate-slide-down">
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
      <div
        class="p-4 bg-white rounded-xl border border-thistle text-center shadow-sm">
        <p class="text-[9px]font-black opacity-40 tracking-widest mb-1">
          titoli bibliomap
        </p>
        <p class="font-bold text-lg text-[var(--paynes-gray)]">
          {{ totalSummary.books }}
        </p>
      </div>
      <div
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      <div class="bg-white p-5 rounded-2xl shadow-sm border border-thistle">
        <p class="text-xs font-bold opacity-50 mb-6">andamento prestiti</p>
        <canvas ref="lineChartCanvas"></canvas>
      </div>

      <div class="bg-white p-5 rounded-2xl shadow-sm border border-thistle">
        <p class="text-xs font-bold opacity-50 mb-6">richieste per settimana</p>
        <canvas ref="requestsChartCanvas"></canvas>
      </div>

      <div class="bg-white p-5 rounded-2xl shadow-sm border border-thistle">
        <p class="text-xs font-bold opacity-50 mb-6">
          titoli piu prestati (pareto)
        </p>
