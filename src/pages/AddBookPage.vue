<template>
  <div
    ...
    <button
      @click="handleCancel"
      aria-label="torna indietro o salta"
    ...
    <div
      ...
      <!-- seleziona libreria quando piu di una disponibile -->
      <select v-else v-model="form.targetLibraryId" class="filter-input" aria-label="seleziona libreria di destinazione">
    ...
    <!-- pulsanti per scegliere metodo inserimento isbn o manuale -->
    <div
      ...
      <button
        ...
        "
        aria-label="inserisci dati manualmente"
      ...
      <button
        ...
        :class="
          inputMode === 'isbn'
            ...
            : 'bg-theme-primary border-border-color text-theme-main'
        "
        aria-label="ricerca tramite codice isbn"
        class="p-4 rounded-xl shadow-sm transition duration-150 font-bold border-2 uppercase text-xs">
    ...
    <!-- sezione ricerca isbn con scanner e input manuale -->
    <div
        ...
        <div class="flex-grow space-y-2">
          <div class="flex items-center gap-2">
            ...
            <div class="relative group">
              <button
                aria-label="informazioni sul codice isbn"
          ...
          <div class="flex gap-2">
            <input
              ...
              class="filter-input" />
            <!-- ricerca libro dal codice isbn inserito -->
            <button
              @click="fetchBookByIsbn"
              :disabled="!isIsbnValid"
              aria-label="ricerca libro per isbn"
              class="btn-sort px-4">
              <i class="fa-solid fa-search"></i>
            </button>
          </div>
        </div>
        <!-- avvia scanner fotocamera per leggere isbn -->
        <button
          @click="handleStartScan"
          aria-label="apri scanner fotocamera"
      ...
      <!-- area scanner attivo con fotocamera -->
      <div v-else class="space-y-4">
        <div
          ref="scannerContainer"
          id="scanner-container"
          aria-label="area scanner fotocamera attivo"
    ...
    <div
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
        <div
          ...
          "
          aria-label="area caricamento copertina libro"
          ...
          <div v-if="previewUrl" class="relative group">
            <img
              :src="previewUrl"
              alt="anteprima copertina libro"
              class="h-32 object-contain rounded shadow-md" />
            <!-- rimuovi copertina caricata -->
            <button
              @click.stop="removeCover"
              type="button"
              aria-label="elimina copertina"
        ...
        <!-- scatta foto alla copertina con fotocamera -->
        <button
          @click="startPhotoCapture"
          aria-label="scatta foto alla copertina del libro"
      ...
      <!-- campi dati libro titolo autore editore anno lingua -->
      <div
        ...
        <div class="grid grid-cols-2 gap-4 md:col-span-2">
          <div>
            ...
            <input
              ...
              type="number"
              aria-label="anno di pubblicazione"
              class="filter-input" />
          </div>
          <div>
            <label class="block text-[10px] font-bold opacity-70 mb-1 uppercase"
            ...
            <input 
              ...
              type="text" 
              aria-label="lingua del libro"
              class="filter-input" />
          </div>
        </div>
      </div>

      <!-- dati della copia personale condizione stato tag note -->
      <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label class="block text-[10px] font-bold opacity-70 mb-2 uppercase"
              >condizione *</label
            >
            <!-- selezione condizione fisica libro -->
              ...
              <button
                ...
                :class="
                  copyForm.condition === cond.value
                    ...
                    : 'bg-theme-primary border-border-color text-theme-main'
                "
                :aria-pressed="copyForm.condition === cond.value"
          ...
          <div>
            <label class="block text-[10px] font-bold opacity-70 mb-2 uppercase"
              >stato *</label
            >
            <!-- selezione stato disponibilita libro -->
            <div class="flex flex-wrap gap-2">
              <button
                ...
                :class="
                  copyForm.status === stat.value
                    ...
                    : 'bg-theme-primary border-border-color text-theme-main'
                "
                :aria-pressed="copyForm.status === stat.value"
                class="px-3 py-1.5 rounded-lg text-[10px] font-bold border-2 transition-all uppercase">
                {{ stat.label }}
              </button>
            </div>
        ...
        <!-- gestione tag e generi libro -->
        <div>
          <label class="block text-[10px] font-bold opacity-70 mb-2 uppercase"
            >tag e generi</label
          >
          <div class="tag-list tag-list-scrollable" role="region" aria-label="elenco tag e generi">
            <!-- tag selezionati con opzione rimozione -->
            <button
            ...
            <!-- tag disponibili non selezionati -->
            <button
            ...
            <!-- pulsante per aggiungere tag personalizzato -->
            <button
              v-if="!showTagInput"
              @click="showTagInput = true"
              aria-label="aggiungi tag personalizzato"
            ...
            <div v-else class="flex gap-1">
              ...
              <button
                @click="addCustomTag"
                aria-label="conferma tag personalizzato"
        ...
        <div>
          ...
          <textarea
            ...
            rows="3"
            aria-label="aggiungi note personali sul libro"
    ...
    <!-- pulsanti azione annulla e salva -->
    <div v-if="hasLibraries" class="flex gap-4 pt-6">
      <button
        @click="handleCancel"
        aria-label="annulla inserimento libro"
    ...
    <!-- modal conflitto libri simili trovati -->
    <div
      ...
      <div
        ...
        <h3 id="conflict-modal-title" class="font-display text-lg mb-4 text-theme-main uppercase">
        ...
        <div class="space-y-3 max-h-80 overflow-y-auto pr-2">
          <button
            ...
            :aria-label="`seleziona ${book.title} di ${book.author}`"
        ...
        <button
          ...
          aria-label="chiudi modal e inserisci dati manualmente"
    ...
    <div
      ...
      <div
        ...
        <h3 id="isbn-modal-title" class="font-display text-lg text-theme-main uppercase">
          isbn mancante
        </h3>
        ...
        <div class="flex gap-2 items-center justify-center">
          <input
            ...
            type="text"
            placeholder="978..."
            aria-label="inserisci codice isbn per completare salvataggio"
        ...
        <div class="flex flex-col gap-2 mt-4">
          ...
          <button
            ...
            aria-label="annulla e ritorna al form"
    ...
    <!-- sezione capture e crop foto copertina -->
    <div
      v-if="isCapturingPhoto || isCropping"
      class="fixed inset-0 z-[100] bg-black flex flex-col items-center justify-center p-6"
      role="dialog"
      aria-modal="true"
      :aria-labelledby="isCapturingPhoto ? 'photo-capture-title' : 'photo-crop-title'">
      <!-- cattura foto da fotocamera -->
      <div
        ...
        <div class="mt-8 flex gap-6">
          ...
          <!-- annulla cattura foto -->
          <button
            @click="stopPhotoCapture"
            aria-label="annulla cattura foto"
      ...
      <div
        ...
        <h2 id="photo-crop-title" class="text-white mb-4 font-bold uppercase">regola l'immagine</h2>
        <div
          ...
          role="region"
          aria-label="area crop immagine">
          <img
            :src="rawImageData"
            alt="immagine da regolare"
        ...
        <div class="flex items-center gap-4 mt-6">
          ...
          <input
            ...
            aria-label="regola zoom immagine"
            class="w-32 accent-accent-color" />
          <!-- aumenta zoom immagine -->
          <button
...
// router e route per navigazione
const route = useRoute();
const router = useRouter();

// calcola destinazione ritorno da parametri query
const returnTo = computed(() => route.query.returnTo || "/");
// verifica se in modalita setup
const isSetup = computed(() => route.query.isSetup === "true");

// librerie utente e stato caricamento
const userLibraries = ref([]);
const isFetchingLibraries = ref(false);
// modalita input isbn o manuale
const inputMode = ref(null);
const isSubmitting = ref(false);
const isSearching = ref(false);
// gestione modal generica
...
// cache ricerche manuali
const searchCache = new Map();

// form dati libro principale
const form = ref({
  targetLibraryId: "",
  isbn: "",
  title: "",
...
// traccia se dettagli libro trovati
const bookDetailsFound = ref(false);
// campi bloccati da edit quando dati da ricerca
const lockedFields = ref([]);
// gestione input tag personalizzato
...
// carica librerie utente al mount
onMounted(() => {
...
// torna a pagina precedente o home
function handleCancel() {
  router.push(returnTo.value);
}
// chiudi modal e naviga se successo
function handleModalClose() {
  isModalOpen.value = false;
  if (isSuccess.value) router.push(returnTo.value);
}

// avvia scanner barcode fotocamera
...
// ricerca libro da api tramite isbn
...
// applica dati libro trovato al form
...
// invia libro a salvataggio con validazione isbn
...
// carica immagine copertina da input file
...
// gestisce drop immagine copertina
...
// applica crop e salva immagine come blob
function applyCrop() {
...
// rimuove copertina caricata
function removeCover() {
  form.value.coverFile = null;
  previewUrl.value = null;
  rawImageData.value = null;
}
// avvia cattura foto da fotocamera posteriore
...
// cattura frame da video e prepara crop
function takePhoto() {
...
// cambia modalita input isbn o manuale
function switchMode(m) {
  inputMode.value = m;
  if (m === "manual") lockedFields.value = [];
}
// mostra modal notifica generica
...
// ricerca libro da titolo autore con debounce
...
// gestisci risultati ricerca libro da titolo
...
// trigger ricerca quando titolo autore cambiano
...
<style scoped>
/* contenitore scanner barcode video canvas */
#scanner-container {
  position: relative;
  width: 100%;
  height: 200px;
...
/* video e canvas riempiono contenitore */
...
/* contenitore tag con scroll */
.tag-list {
  max-height: 120px;
  overflow-y: auto;
}

/* stilizzazione scrollbar tag */
